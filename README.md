...
## Web интерфейс управляющего блока

Ввиду [отсутвия у оборудования программного api,](https://ab-log.ru/forum/viewtopic.php?f=5&t=1740) пришлось изобрести костыли для "облагораживания web интерфеса".
...
В худшем случае дизайн местами будет проскакивать родной от производителя.
