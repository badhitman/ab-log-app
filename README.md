...
Напомню имя официального и бота по регистрации личных ботов: @BotFather. Срзу после регистрации можно сразу прописать несколько команд:
 ...
 Собственно для того что бы изначально связать клиента с пользователем нужно написать любое сообщение боту с клиента Telegram, после чего это пользователь появится в разделе "Telegram bot".
