...
Дополнительно комнда может указать на необходимость прекратить выполнение скрипта либо на переход в произвольный скрипт на произвольную позицию для продолжения выполнения.
